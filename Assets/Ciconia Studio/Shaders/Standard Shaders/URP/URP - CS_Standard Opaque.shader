Shader "Ciconia Studio/CS_Standard/URP/Standard/Opaque"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(CiconiaStudioCS_StandardURPStandardOpaque)
			...
			UNITY_INSTANCING_BUFFER_END(CiconiaStudioCS_StandardURPStandardOpaque)
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float4 _BaseMap_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardOpaque,_BaseMap_ST);
				float2 uv_BaseMap = IN.ase_texcoord8.xy * _BaseMap_ST_Instance.xy + _BaseMap_ST_Instance.zw;
				float2 break26_g675 = uv_BaseMap;
				...
				float4 _ParallaxMap_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardOpaque,_ParallaxMap_ST);
				...
				float4 tex2DNode7_g674 = tex2D( _BaseMap, ( ( appendResult14_g675 + appendResult13_g675 ) + Parallaxe376 ) );
				float4 lerpResult53_g674 = lerp( _BaseColor , ( ( _BaseColor * tex2DNode7_g674 ) * _BaseColor.a ) , _BaseColor.a);
				float clampResult27_g674 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g674 = lerpResult53_g674.rgb;
				float desaturateDot29_g674 = dot( desaturateInitialColor29_g674, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g674 = lerp( desaturateInitialColor29_g674, desaturateDot29_g674.xxx, -clampResult27_g674 );
				float4 temp_output_499_0 = CalculateContrast(_Brightness,float4( desaturateVar29_g674 , 0.0 ));
				float4 _DetailAlbedoMap_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardOpaque,_DetailAlbedoMap_ST);
				...
				float2 texCoord453 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode458 = tex2D( _DetailMask, texCoord453 );
				#if defined(_CHANNELSELECTIONMASK1_RED)
				float staticSwitch493 = tex2DNode458.r;
				#elif defined(_CHANNELSELECTIONMASK1_GREEN)
				float staticSwitch493 = tex2DNode458.g;
				#elif defined(_CHANNELSELECTIONMASK1_BLUE)
				float staticSwitch493 = tex2DNode458.b;
				#elif defined(_CHANNELSELECTIONMASK1_ALPHA)
				float staticSwitch493 = tex2DNode458.a;
				#else
				float staticSwitch493 = tex2DNode458.r;
				#endif
				float2 appendResult455 = (float2(_TriplanarXYTilingXYZWOffsetXY.x , _TriplanarXYTilingXYZWOffsetXY.y));
				float _TriplanarFalloff_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardOpaque,_TriplanarFalloff);
				#if defined(_TRIPLANARSPACEPROJECTION_OBJECTSPACE)
				float3 staticSwitch452 = IN.ase_texcoord9.xyz;
				#elif defined(_TRIPLANARSPACEPROJECTION_WORLDSPACE)
				float3 staticSwitch452 = WorldPosition;
				#else
				float3 staticSwitch452 = IN.ase_texcoord9.xyz;
				#endif
				float2 appendResult451 = (float2(_TriplanarXYTilingXYZWOffsetXY.z , _TriplanarXYTilingXYZWOffsetXY.w));
				float4 triplanar459 = TriplanarSampling459( _DetailMask, ( staticSwitch452 + float3( appendResult451 ,  0.0 ) ), IN.ase_normal, _TriplanarFalloff_Instance, appendResult455, 1.0, 0 );
				#if defined(_CHANNELSELECTIONMASK1_RED)
				float staticSwitch492 = triplanar459.x;
				#elif defined(_CHANNELSELECTIONMASK1_GREEN)
				float staticSwitch492 = triplanar459.g;
				#elif defined(_CHANNELSELECTIONMASK1_BLUE)
				float staticSwitch492 = triplanar459.b;
				#elif defined(_CHANNELSELECTIONMASK1_ALPHA)
				float staticSwitch492 = triplanar459.a;
				#else
				float staticSwitch492 = triplanar459.x;
				#endif
				float4 temp_cast_8 = ((( _InvertMask )?( ( 1.0 - (( _EnableTriplanarProjection )?( staticSwitch492 ):( staticSwitch493 )) ) ):( (( _EnableTriplanarProjection )?( staticSwitch492 ):( staticSwitch493 )) ))).xxxx;
				float4 clampResult473 = clamp( ( CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_8) + -_SpreadDetailMap ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float MaskIntensity471 = _IntensityMask;
				float4 Mask158 = (( _EnableDetailMask )?( ( clampResult473 * MaskIntensity471 ) ):( temp_cast_6 ));
				float4 lerpResult343 = lerp( temp_output_499_0 , AlbedoDetail153 , Mask158);
				float4 blendOpSrc15_g643 = temp_output_499_0;
				float4 blendOpDest15_g643 = lerpResult343;
				float4 lerpBlendMode15_g643 = lerp(blendOpDest15_g643,(( blendOpDest15_g643 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest15_g643 ) * ( 1.0 - blendOpSrc15_g643 ) ) : ( 2.0 * blendOpDest15_g643 * blendOpSrc15_g643 ) ),Mask158.x);
				#if defined(_BLENDMODE_NONE)
				float4 staticSwitch22_g643 = lerpResult343;
				#elif defined(_BLENDMODE_OVERLAY)
				float4 staticSwitch22_g643 = ( saturate( lerpBlendMode15_g643 ));
				#else
				float4 staticSwitch22_g643 = lerpResult343;
				#endif
				float4 Albedo26 = (( _VisualizeMask )?( Mask158 ):( staticSwitch22_g643 ));
				
				float4 _BumpMap_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardOpaque,_BumpMap_ST);
				float2 uv_BumpMap = IN.ase_texcoord8.xy * _BumpMap_ST_Instance.xy + _BumpMap_ST_Instance.zw;
				float2 break26_g677 = uv_BumpMap;
				float2 appendResult14_g677 = (float2(( break26_g677.x * GlobalTilingX11 ) , ( break26_g677.y * GlobalTilingY8 )));
				float2 appendResult13_g677 = (float2(( break26_g677.x + GlobalOffsetX10 ) , ( break26_g677.y + GlobalOffsetY9 )));
				float3 unpack4_g676 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g677 + appendResult13_g677 ) + Parallaxe376 ) ), _BumpScale );
				unpack4_g676.z = lerp( 1, unpack4_g676.z, saturate(_BumpScale) );
				float3 tex2DNode4_g676 = unpack4_g676;
				float3 temp_output_500_0 = tex2DNode4_g676;
				float4 _DetailNormalMap_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardOpaque,_DetailNormalMap_ST);
				float2 uv_DetailNormalMap = IN.ase_texcoord8.xy * _DetailNormalMap_ST_Instance.xy + _DetailNormalMap_ST_Instance.zw;
				float3 unpack4_g664 = UnpackNormalScale( tex2D( _DetailNormalMap, uv_DetailNormalMap ), _DetailNormalMapScale );
				unpack4_g664.z = lerp( 1, unpack4_g664.z, saturate(_DetailNormalMapScale) );
				float3 NormalDetail155 = unpack4_g664;
				float3 lerpResult137 = lerp( temp_output_500_0 , NormalDetail155 , Mask158.rgb);
				float3 lerpResult205 = lerp( temp_output_500_0 , BlendNormal( temp_output_500_0 , NormalDetail155 ) , Mask158.rgb);
				float3 Normal27 = (( _BlendMainNormal )?( lerpResult205 ):( lerpResult137 ));
				
				float4 _EmissionMap_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardOpaque,_EmissionMap_ST);
				float2 uv_EmissionMap = IN.ase_texcoord8.xy * _EmissionMap_ST_Instance.xy + _EmissionMap_ST_Instance.zw;
				float2 break26_g681 = uv_EmissionMap;
				float2 appendResult14_g681 = (float2(( break26_g681.x * GlobalTilingX11 ) , ( break26_g681.y * GlobalTilingY8 )));
				float2 appendResult13_g681 = (float2(( break26_g681.x + GlobalOffsetX10 ) , ( break26_g681.y + GlobalOffsetY9 )));
				float4 temp_output_5_0_g680 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g681 + appendResult13_g681 ) + Parallaxe376 ) ) );
				float4 temp_output_502_0 = ( temp_output_5_0_g680 * _EmissionIntensity );
				float4 temp_cast_18 = (0.0).xxxx;
				float4 lerpResult190 = lerp( temp_output_502_0 , temp_cast_18 , Mask158);
				float4 Emission110 = (( _UseEmissionFromMainProperties )?( temp_output_502_0 ):( lerpResult190 ));
				
				float4 _MetallicGlossMap_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardOpaque,_MetallicGlossMap_ST);
				float2 uv_MetallicGlossMap = IN.ase_texcoord8.xy * _MetallicGlossMap_ST_Instance.xy + _MetallicGlossMap_ST_Instance.zw;
				float2 break26_g685 = uv_MetallicGlossMap;
				float2 appendResult14_g685 = (float2(( break26_g685.x * GlobalTilingX11 ) , ( break26_g685.y * GlobalTilingY8 )));
				float2 appendResult13_g685 = (float2(( break26_g685.x + GlobalOffsetX10 ) , ( break26_g685.y + GlobalOffsetY9 )));
				float4 tex2DNode3_g684 = tex2D( _MetallicGlossMap, ( ( appendResult14_g685 + appendResult13_g685 ) + Parallaxe376 ) );
				float4 _DetailMetallicGlossMap_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardOpaque,_DetailMetallicGlossMap_ST);
				float2 uv_DetailMetallicGlossMap = IN.ase_texcoord8.xy * _DetailMetallicGlossMap_ST_Instance.xy + _DetailMetallicGlossMap_ST_Instance.zw;
				float4 tex2DNode3_g672 = tex2D( _DetailMetallicGlossMap, uv_DetailMetallicGlossMap );
				float DetailMetallic176 = ( tex2DNode3_g672.r * _DetailMetallic );
				float lerpResult179 = lerp( ( tex2DNode3_g684.r * _Metallic ) , DetailMetallic176 , Mask158.r);
				float Metallic41 = lerpResult179;
				
				float switchResult34_g684 = (((ase_vface>0)?(_Smoothness):(_SmoothnessBack)));
				float BaseColorAlpha46 = (( _InvertABaseColor1 )?( ( 1.0 - tex2DNode7_g674.a ) ):( tex2DNode7_g674.a ));
				#if defined(_SOURCE_METALLICALPHA)
				float staticSwitch23_g684 = ( tex2DNode3_g684.a * switchResult34_g684 );
				#elif defined(_SOURCE_BASECOLORALPHA)
				float staticSwitch23_g684 = ( switchResult34_g684 * BaseColorAlpha46 );
				#else
				float staticSwitch23_g684 = ( tex2DNode3_g684.a * switchResult34_g684 );
				#endif
				float DetailBaseColorAlpha170 = tex2DNode7_g612.a;
				#if defined(_DETAILSOURCE_METALLICALPHA)
				float staticSwitch23_g672 = ( tex2DNode3_g672.a * _DetailGlossiness );
				#elif defined(_DETAILSOURCE_BASECOLORALPHA)
				float staticSwitch23_g672 = ( _DetailGlossiness * DetailBaseColorAlpha170 );
				#else
				float staticSwitch23_g672 = ( tex2DNode3_g672.a * _DetailGlossiness );
				#endif
				float DetailSmoothness175 = staticSwitch23_g672;
				float lerpResult182 = lerp( staticSwitch23_g684 , DetailSmoothness175 , Mask158.r);
				float Smoothness40 = lerpResult182;
				
				float4 _OcclusionMap_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardOpaque,_OcclusionMap_ST);
				float2 uv_OcclusionMap = IN.ase_texcoord8.xy * _OcclusionMap_ST_Instance.xy + _OcclusionMap_ST_Instance.zw;
				float2 break26_g679 = uv_OcclusionMap;
				float2 appendResult14_g679 = (float2(( break26_g679.x * GlobalTilingX11 ) , ( break26_g679.y * GlobalTilingY8 )));
				float2 appendResult13_g679 = (float2(( break26_g679.x + GlobalOffsetX10 ) , ( break26_g679.y + GlobalOffsetY9 )));
				float blendOpSrc2_g678 = tex2D( _OcclusionMap, ( ( appendResult14_g679 + appendResult13_g679 ) + Parallaxe376 ) ).r;
				float blendOpDest2_g678 = ( 1.0 - _OcclusionStrength );
				float temp_output_501_0 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc2_g678 ) * ( 1.0 - blendOpDest2_g678 ) ) ));
				float lerpResult185 = lerp( temp_output_501_0 , 1.0 , Mask158.r);
				float AmbientOcclusion94 = (( _UseAoFromMainProperties )?( temp_output_501_0 ):( lerpResult185 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float _TriplanarFalloff_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardOpaque,_TriplanarFalloff);
				#if defined(_TRIPLANARSPACEPROJECTION_OBJECTSPACE)
				float3 staticSwitch452 = IN.ase_texcoord8.xyz;
				#elif defined(_TRIPLANARSPACEPROJECTION_WORLDSPACE)
				float3 staticSwitch452 = WorldPosition;
				#else
				float3 staticSwitch452 = IN.ase_texcoord8.xyz;
				...
				float4 lerpResult190 = lerp( temp_output_502_0 , temp_cast_16 , Mask158);
				float4 Emission110 = (( _UseEmissionFromMainProperties )?( temp_output_502_0 ):( lerpResult190 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float _TriplanarFalloff_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardOpaque,_TriplanarFalloff);
				#if defined(_TRIPLANARSPACEPROJECTION_OBJECTSPACE)
				float3 staticSwitch452 = IN.ase_texcoord6.xyz;
				#elif defined(_TRIPLANARSPACEPROJECTION_WORLDSPACE)
				float3 staticSwitch452 = WorldPosition;
				#else
				float3 staticSwitch452 = IN.ase_texcoord6.xyz;
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float _TriplanarFalloff_Instance = UNITY_ACCESS_INSTANCED_PROP(CiconiaStudioCS_StandardURPStandardOpaque,_TriplanarFalloff);
				#if defined(_TRIPLANARSPACEPROJECTION_OBJECTSPACE)
				float3 staticSwitch452 = IN.ase_texcoord7.xyz;
				#elif defined(_TRIPLANARSPACEPROJECTION_WORLDSPACE)
				float3 staticSwitch452 = WorldPosition;
				#else
				float3 staticSwitch452 = IN.ase_texcoord7.xyz;
				...
				float staticSwitch492 = triplanar459.x;
				#endif
				float4 temp_cast_4 = ((( _InvertMask )?( ( 1.0 - (( _EnableTriplanarProjection )?( staticSwitch492 ):( staticSwitch493 )) ) ):( (( _EnableTriplanarProjection )?( staticSwitch492 ):( staticSwitch493 )) ))).xxxx;
				float4 clampResult473 = clamp( ( CalculateContrast(( _ContrastDetailMap + 1.0 ),temp_cast_4) + -_SpreadDetailMap ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float MaskIntensity471 = _IntensityMask;
